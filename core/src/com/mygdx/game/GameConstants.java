...
//Created some variables to set position correctly of buttons and ext.
public class GameConstants {
    ...
    public int column;
    public int row;
    public static int col_width = screenWidth/8;
    public static int row_height = screenHeight/8;
